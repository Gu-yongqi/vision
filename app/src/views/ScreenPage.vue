<template>
  <div class="screen-container" :style="containerStyle">
    <header class="screen-header">
      ...
      <span class="logo">五阿哥不上朝</span>
      <span class="title">电商平台实时监控系统</span>
      <div class="title-right">
        <img src="static/img/logo.png" alt="" class="tx">
        <img :src="themeSrc" class="qiehuan" @click="handleChangeTheme">
        <span class="datetime">{{n+'-'+y+'-'+r+' '+s+':'+f+':'+m}}</span>
      </div>
    </header>
  ...
  methods: {
    ...
    date() {
      setInterval(v => {
        ...
        this.f = this.f < 10 ? '0' + this.f : this.f
        this.m = date.getSeconds()
